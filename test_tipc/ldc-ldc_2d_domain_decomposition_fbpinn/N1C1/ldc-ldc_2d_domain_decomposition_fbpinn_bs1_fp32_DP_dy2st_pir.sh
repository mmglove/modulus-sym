model_item=ldc-ldc_2d_domain_decomposition_fbpinn_bs1_fp32_DP_dy2st_pir
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/ldc-ldc_2d_domain_decomposition_fbpinn/N1C1/ldc-ldc_2d_domain_decomposition_fbpinn_bs1_fp32_DP_dy2st_pir.sh ./
