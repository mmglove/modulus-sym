model_item=limerock-limerock_transfer_learning-limerock_flow_bs1_fp32_DP_dy2st_pir_prim_cinn
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/limerock-limerock_transfer_learning-limerock_flow/N1C1/limerock-limerock_transfer_learning-limerock_flow_bs1_fp32_DP_dy2st_pir_prim_cinn.sh ./
