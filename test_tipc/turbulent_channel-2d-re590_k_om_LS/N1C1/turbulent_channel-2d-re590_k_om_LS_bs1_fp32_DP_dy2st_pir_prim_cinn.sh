model_item=turbulent_channel-2d-re590_k_om_LS_bs1_fp32_DP_dy2st_pir_prim_cinn
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/turbulent_channel-2d-re590_k_om_LS/N1C1/turbulent_channel-2d-re590_k_om_LS_bs1_fp32_DP_dy2st_pir_prim_cinn.sh ./
