model_item=wave_equation-wave_1d_causal_bs1_fp32_DP_dy2st_pir_prim
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/wave_equation-wave_1d_causal/N1C1/wave_equation-wave_1d_causal_bs1_fp32_DP_dy2st_pir_prim.sh ./
