model_item=annular_ring-annular_ring_gradient_enhanced-annular_ring_gradient_enhanced_bs1_fp32_DP_dy2st_pir_prim_cinn
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/annular_ring-annular_ring_gradient_enhanced-annular_ring_gradient_enhanced/N1C1/annular_ring-annular_ring_gradient_enhanced-annular_ring_gradient_enhanced_bs1_fp32_DP_dy2st_pir_prim_cinn.sh ./
