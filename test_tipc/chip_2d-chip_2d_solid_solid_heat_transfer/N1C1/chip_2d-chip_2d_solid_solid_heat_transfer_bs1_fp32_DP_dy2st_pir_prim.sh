model_item=chip_2d-chip_2d_solid_solid_heat_transfer_bs1_fp32_DP_dy2st_pir_prim
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/chip_2d-chip_2d_solid_solid_heat_transfer/N1C1/chip_2d-chip_2d_solid_solid_heat_transfer_bs1_fp32_DP_dy2st_pir_prim.sh ./
