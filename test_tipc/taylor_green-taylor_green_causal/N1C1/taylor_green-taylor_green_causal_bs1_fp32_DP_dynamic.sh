model_item=taylor_green-taylor_green_causal_bs1_fp32_DP_dynamic.sh
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/taylor_green-taylor_green_causal/N1C1/taylor_green-taylor_green_causal_bs1_fp32_DP_dynamic.sh ./
