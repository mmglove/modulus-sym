model_item=anti_derivative-data_informed_bs1_fp32_DP_dy2st_pir_prim_cinn
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/anti_derivative-data_informed/N1C1/anti_derivative-data_informed_bs1_fp32_DP_dy2st_pir_prim_cinn.sh ./
