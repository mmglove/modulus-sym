model_item=helmholtz-helmholtz_hardBC_bs1_fp32_DP_dynamic.sh
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/helmholtz-helmholtz_hardBC/N1C1/helmholtz-helmholtz_hardBC_bs1_fp32_DP_dynamic.sh ./
