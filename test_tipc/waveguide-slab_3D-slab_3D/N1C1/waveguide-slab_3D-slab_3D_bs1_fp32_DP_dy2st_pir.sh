model_item=waveguide-slab_3D-slab_3D_bs1_fp32_DP_dy2st_pir
bs_item=1
fp_item=fp32
run_mode=DP
device_num=N1C1
...
\cp test_tipc/waveguide-slab_3D-slab_3D/N1C1/waveguide-slab_3D-slab_3D_bs1_fp32_DP_dy2st_pir.sh ./
