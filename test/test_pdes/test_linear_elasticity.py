...
def test_linear_elasticity_equations():
    ...
    evaluations_stress_disp_xx = linear_elasticity_eq.make_nodes()[0].evaluate(
        {
            "u__x": paddle.to_tensor(u__x, dtype="float32"),
            "v__y": paddle.to_tensor(v__y, dtype="float32"),
            "w__z": paddle.to_tensor(w__z, dtype="float32"),
            "sigma_xx": paddle.to_tensor(sigma_xx, dtype="float32"),
        }
    )
    evaluations_stress_disp_yy = linear_elasticity_eq.make_nodes()[1].evaluate(
        {
            ...
            "v__y": paddle.to_tensor(v__y, dtype="float32"),
            "w__z": paddle.to_tensor(w__z, dtype="float32"),
            "sigma_yy": paddle.to_tensor(sigma_yy, dtype="float32"),
        }
    )
    evaluations_stress_disp_zz = linear_elasticity_eq.make_nodes()[2].evaluate(
        {
            ...
            "v__y": paddle.to_tensor(v__y, dtype="float32"),
            "w__z": paddle.to_tensor(w__z, dtype="float32"),
            "sigma_zz": paddle.to_tensor(sigma_zz, dtype="float32"),
        }
    )
    evaluations_stress_disp_xy = linear_elasticity_eq.make_nodes()[3].evaluate(
        {
            "u__y": paddle.to_tensor(u__y, dtype="float32"),
            "v__x": paddle.to_tensor(v__x, dtype="float32"),
            "sigma_xy": paddle.to_tensor(sigma_xy, dtype="float32"),
        }
    )
    evaluations_stress_disp_xz = linear_elasticity_eq.make_nodes()[4].evaluate(
        {
            "u__z": paddle.to_tensor(u__z, dtype="float32"),
            "w__x": paddle.to_tensor(w__x, dtype="float32"),
            "sigma_xz": paddle.to_tensor(sigma_xz, dtype="float32"),
        }
    )
    evaluations_stress_disp_yz = linear_elasticity_eq.make_nodes()[5].evaluate(
        {
            "v__z": paddle.to_tensor(v__z, dtype="float32"),
            "w__y": paddle.to_tensor(w__y, dtype="float32"),
            "sigma_yz": paddle.to_tensor(sigma_yz, dtype="float32"),
        }
    )
    evaluations_equilibrium_x = linear_elasticity_eq.make_nodes()[6].evaluate(
        {
            "u__t__t": paddle.to_tensor(u__t__t, dtype="float32"),
            "sigma_xx__x": paddle.to_tensor(sigma_xx__x, dtype="float32"),
            "sigma_xy__y": paddle.to_tensor(sigma_xy__y, dtype="float32"),
            "sigma_xz__z": paddle.to_tensor(sigma_xz__z, dtype="float32"),
        }
    )
    evaluations_equilibrium_y = linear_elasticity_eq.make_nodes()[7].evaluate(
        {
            "v__t__t": paddle.to_tensor(v__t__t, dtype="float32"),
            "sigma_xy__x": paddle.to_tensor(sigma_xy__x, dtype="float32"),
            "sigma_yy__y": paddle.to_tensor(sigma_yy__y, dtype="float32"),
            "sigma_yz__z": paddle.to_tensor(sigma_yz__z, dtype="float32"),
        }
    )
    evaluations_equilibrium_z = linear_elasticity_eq.make_nodes()[8].evaluate(
        {
            "w__t__t": paddle.to_tensor(w__t__t, dtype="float32"),
            "sigma_xz__x": paddle.to_tensor(sigma_xz__x, dtype="float32"),
            "sigma_yz__y": paddle.to_tensor(sigma_yz__y, dtype="float32"),
            "sigma_zz__z": paddle.to_tensor(sigma_zz__z, dtype="float32"),
        }
    )
    evaluations_traction_x = linear_elasticity_eq.make_nodes()[9].evaluate(
        {
            "normal_x": paddle.to_tensor(normal_x, dtype="float32"),
            "normal_y": paddle.to_tensor(normal_y, dtype="float32"),
            "normal_z": paddle.to_tensor(normal_z, dtype="float32"),
            "sigma_xx": paddle.to_tensor(sigma_xx, dtype="float32"),
            "sigma_xy": paddle.to_tensor(sigma_xy, dtype="float32"),
            "sigma_xz": paddle.to_tensor(sigma_xz, dtype="float32"),
        }
    ...
    evaluations_navier_x = linear_elasticity_eq.make_nodes()[12].evaluate(
        {
            ...
            "v__x__y": paddle.to_tensor(v__x__y, dtype="float32"),
            "w__x__z": paddle.to_tensor(w__x__z, dtype="float32"),
    ...
    evaluations_navier_y = linear_elasticity_eq.make_nodes()[13].evaluate(
        {
            "v__t__t": paddle.to_tensor(v__t__t, dtype="float32"),
            "u__x__y": paddle.to_tensor(u__x__y, dtype="float32"),
            "v__y__y": paddle.to_tensor(v__y__y, dtype="float32"),
            "w__y__z": paddle.to_tensor(w__y__z, dtype="float32"),
            "v__x__x": paddle.to_tensor(v__x__x, dtype="float32"),
            "v__z__z": paddle.to_tensor(v__z__z, dtype="float32"),
        }
    )
    evaluations_navier_z = linear_elasticity_eq.make_nodes()[14].evaluate(
        {
            "w__t__t": paddle.to_tensor(w__t__t, dtype="float32"),
            "u__x__z": paddle.to_tensor(u__x__z, dtype="float32"),
            "v__y__z": paddle.to_tensor(v__y__z, dtype="float32"),
            "w__x__x": paddle.to_tensor(w__x__x, dtype="float32"),
            "w__y__y": paddle.to_tensor(w__y__y, dtype="float32"),
            "w__z__z": paddle.to_tensor(w__z__z, dtype="float32"),
        }
    )
