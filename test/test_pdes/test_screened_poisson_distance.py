...
def test_screened_poisson_distance_equation():
    ...
    evaluations = screened_poisson_distance_eq.make_nodes()[0].evaluate(
        {
            "distance__x": paddle.to_tensor(distance__x, dtype="float32"),
            "distance__y": paddle.to_tensor(distance__y, dtype="float32"),
            "distance__z": paddle.to_tensor(distance__z, dtype="float32"),
            "distance__x__x": paddle.to_tensor(distance__x__x, dtype="float32"),
            "distance__y__y": paddle.to_tensor(distance__y__y, dtype="float32"),
            "distance__z__z": paddle.to_tensor(distance__z__z, dtype="float32"),
        }
    )
