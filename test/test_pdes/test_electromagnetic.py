...
def test_maxwell_freq_real():
    ...
    evaluations_MaxwellFreqReal_x = maxwell_eq.make_nodes()[0].evaluate(
        {
            "ux": paddle.to_tensor(ux, dtype="float32"),
            "uy__x__y": paddle.to_tensor(uy__x__y, dtype="float32"),
            "ux__y__y": paddle.to_tensor(ux__y__y, dtype="float32"),
            "ux__z__z": paddle.to_tensor(ux__z__z, dtype="float32"),
            "uz__x__z": paddle.to_tensor(uz__x__z, dtype="float32"),
        }
    )
    evaluations_MaxwellFreqReal_y = maxwell_eq.make_nodes()[1].evaluate(
        {
            "uy": paddle.to_tensor(uy, dtype="float32"),
            "uz__y__z": paddle.to_tensor(uz__y__z, dtype="float32"),
            "uy__z__z": paddle.to_tensor(uy__z__z, dtype="float32"),
            "uy__x__x": paddle.to_tensor(uy__x__x, dtype="float32"),
            "ux__x__y": paddle.to_tensor(ux__x__y, dtype="float32"),
        }
    )
    evaluations_MaxwellFreqReal_z = maxwell_eq.make_nodes()[2].evaluate(
        {
            "uz": paddle.to_tensor(uz, dtype="float32"),
            "ux__x__z": paddle.to_tensor(ux__x__z, dtype="float32"),
            "uz__x__x": paddle.to_tensor(uz__x__x, dtype="float32"),
            "uz__y__y": paddle.to_tensor(uz__y__y, dtype="float32"),
            "uy__y__z": paddle.to_tensor(uy__y__z, dtype="float32"),
        }
    )
    ...
    evaluations_SommerfeldBC_real_x = sommerfeld_bc.make_nodes()[0].evaluate(
        {
            ...
            "ux__y": paddle.to_tensor(ux__y, dtype="float32"),
            "uy__x": paddle.to_tensor(uy__x, dtype="float32"),
            "ux__z": paddle.to_tensor(ux__z, dtype="float32"),
            "uz__x": paddle.to_tensor(uz__x, dtype="float32"),
        }
    )
    evaluations_SommerfeldBC_real_y = sommerfeld_bc.make_nodes()[1].evaluate(
        {
            ...
            "ux__y": paddle.to_tensor(ux__y, dtype="float32"),
            "uy__x": paddle.to_tensor(uy__x, dtype="float32"),
            "uy__z": paddle.to_tensor(uy__z, dtype="float32"),
            "uz__y": paddle.to_tensor(uz__y, dtype="float32"),
        }
    )
