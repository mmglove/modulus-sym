...
def test_diffusion_interface():
    ...
    evaluations = eq.make_nodes()[0].evaluate(
        {
            "u_1": paddle.to_tensor(u_1, dtype="float32"),
            "u_2": paddle.to_tensor(u_2, dtype="float32"),
        }
    )
    ...
    evaluations = eq.make_nodes()[1].evaluate(
        {
            "u_1": paddle.to_tensor(u_1, dtype="float32"),
            "u_2": paddle.to_tensor(u_2, dtype="float32"),
            "u_1__x": paddle.to_tensor(u_1__x, dtype="float32"),
            "u_1__y": paddle.to_tensor(u_1__y, dtype="float32"),
            "u_1__z": paddle.to_tensor(u_1__z, dtype="float32"),
            "u_2__x": paddle.to_tensor(u_2__x, dtype="float32"),
            "u_2__y": paddle.to_tensor(u_2__y, dtype="float32"),
            "u_2__z": paddle.to_tensor(u_2__z, dtype="float32"),
