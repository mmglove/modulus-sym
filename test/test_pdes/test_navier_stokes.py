...
def test_navier_stokes_equation():
    ...
    evaluations_momentum_x = navier_stokes_eq.make_nodes()[1].evaluate(
        {
            "u__t": paddle.to_tensor(u__t, dtype="float32"),
            "u__x": paddle.to_tensor(u__x, dtype="float32"),
            ...
            "p__x": paddle.to_tensor(p__x, dtype="float32"),
    ...
    evaluations_momentum_y = navier_stokes_eq.make_nodes()[2].evaluate(
        {
            "v__t": paddle.to_tensor(v__t, dtype="float32"),
            ...
            "p__y": paddle.to_tensor(p__y, dtype="float32"),
            "u": paddle.to_tensor(u, dtype="float32"),
            "v": paddle.to_tensor(v, dtype="float32"),
            "w": paddle.to_tensor(w, dtype="float32"),
        }
    ...
    evaluations_momentum_z = navier_stokes_eq.make_nodes()[3].evaluate(
        {
            "w__t": paddle.to_tensor(w__t, dtype="float32"),
            ...
            "p__z": paddle.to_tensor(p__z, dtype="float32"),
            "u": paddle.to_tensor(u, dtype="float32"),
            "v": paddle.to_tensor(v, dtype="float32"),
            "w": paddle.to_tensor(w, dtype="float32"),
        }
